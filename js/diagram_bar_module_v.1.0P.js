/* "Diagram (bar, in percent) module", v. 1.0P - 01.07.2024 | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
document.getElementById("legend_bar_p_total").innerText = `Total: ${totalValue}`;



    // Create the SVG container
const svg = d3.select("#diagram_bar_p")
    .append("svg")
    .attr("width", width)
    .attr("height", height);
...
const legend =  d3.select("#diagram_bar_legend_p").selectAll(".legend-item")
    ...
    // d3.select("#diagram_bar_legend_p").append("p").attr("class", "legend-total");
...
if (REFRESH) {
    setInterval(() => {
            ...
            const legend = d3.select("#diagram_bar_legend_p")
