...
let theme = {
    ...
    // btn_color: document.body.querySelector("[theme]"), /* Attribute Selector */
    // btn_color: document.body.querySelector(".theme"), /* CSS Selector */
    // btn_color: document.body.querySelector("#theme"), /* ID Selector */
